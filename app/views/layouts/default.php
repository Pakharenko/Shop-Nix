    ...
    <div class="sidebar">
        ...
        <div class="sidebar-nav">
            <ul>
                ...
                <?php foreach ($cat->getCategory() as $category) : ?>
                    ...
                    <!--                                    <li>-->
                        ...
                        <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Illo tempora magni quam ducimus dolor quae minima iusto minus pariatur molestias, eaque quasi, dolorum earum placeat eveniet dolore enim. Magni, hic!</p>
